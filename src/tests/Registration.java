...
public class Registration extends BaseTest {
	...
	public void testRegistrationForm() throws InterruptedException {
		...
		waitForToastMessage.withMessage("Registeration failed : Toast Message is not shown");
		waitForToastMessage
				.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector(".notification-content")));
		waitForToastMessage.withMessage("Toast Message visible");
		waitForToastMessage
				.until(ExpectedConditions.invisibilityOfElementLocated(By.cssSelector(".notification-content")));

		// Assertions if logout is visible
		Assert.assertTrue(driver.findElement(By.className("button-logout")).isDisplayed(),"Logout Button is not visible");
		Assert.assertTrue(driver.findElement(By.className("button-profile")).isDisplayed(),"Profile Button is not visible");
	}
	...
	public void testLogout() throws InterruptedException {
		...
		//Verify if user logs out and profile,logout button are not displayed
		Assert.assertFalse(driver.findElement(By.className("button-logout")).isDisplayed(),"Logout Button is visible");
		Assert.assertFalse(driver.findElement(By.className("button-profile")).isDisplayed(),"Profile Button is not visible");
